...
set t_Co=256
hi Normal guifg=#000000 ctermbg=NONE guibg=#c0c7c8 gui=NONE
...
hi GitGutterAdd guifg=#000000 guibg=NONE
hi cssIncludeKeyword guifg=#000000 guibg=NONE
hi Keyword guifg=#000000 guibg=NONE
hi IncSearch guifg=#000000 guibg=NONE
...
hi Conditional guifg=#000000 guibg=NONE
...
hi Number guifg=#000000 guibg=NONE
...
hi GitGutterChange guifg=#000000 guibg=NONE
hi cssColor guifg=#000000 guibg=NONE
hi Function guifg=#000000 guibg=NONE
hi Directory guifg=#000000 guibg=NONE
hi markdownLinkText guifg=#000000 guibg=NONE
hi javaScriptBoolean guifg=#000000 guibg=NONE
hi Include guifg=#000000 guibg=NONE
hi Storage guifg=#000000 guibg=NONE
hi cssClassName guifg=#000000 guibg=NONE
hi cssClassNameDot guifg=#000000 guibg=NONE
hi Statement guifg=#000000 guibg=NONE
hi Operator guifg=#000000 guibg=NONE
hi cssAttr guifg=#000000 guibg=NONE


hi Pmenu guifg=#000000 guibg=#454545
hi SignColumn guibg=#c0c7c8
hi Title guifg=#000000
hi LineNr guifg=#666666 guibg=#c0c7c8
hi NonText guifg=#c481ff guibg=#c0c7c8
...
hi StatusLine gui=bold guibg=#454545 guifg=#000000
hi StatusLineNC gui=NONE guibg=#c0c7c8 guifg=#000000
hi Search guibg=#c481ff guifg=#c0c7c8
